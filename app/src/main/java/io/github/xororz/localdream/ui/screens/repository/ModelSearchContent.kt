...
private fun previewResults(): List<ModelCatalogSearchResult> = listOf(
    ModelCatalogSearchResult(
        ...
        downloadUrl = "https://hf-mirror.com/xororz/anything-v5/resolve/main/anything-v5.zip",
    ...
    ModelCatalogSearchResult(
        ...
        downloadUrl = "https://hf-mirror.com/xororz/cyberrealistic/resolve/main/cyber.safetensors",
